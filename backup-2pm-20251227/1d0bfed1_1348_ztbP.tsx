...
function TryOnResultComponent(props: TryOnResultProps, ref: React.Ref<HTMLDivElement>) {
  ...
  return (
    <div ref={ref} className="relative">
      <div className="grid grid-cols-1 gap-3 items-start lg:grid-cols-[120px_360px_minmax(0,1fr)] lg:gap-4">
        {/* ========================================
            PANEL 1: GENERATIONS RAIL (Desktop left sidebar)
            ======================================== */}
        <div className="hidden lg:block lg:col-start-1 lg:row-start-1 relative z-0">
          {hasModalGenerations ? (
            <div className="sticky top-3">
              <div className="rounded-xl border border-slate-200 dark:border-slate-700 bg-white/90 dark:bg-slate-900/70 backdrop-blur p-2">
                <div className="flex items-center justify-center mb-2">
                  <div className="text-xs font-black text-slate-900 dark:text-white text-center">إبداعاتي<br/>({modalGenerations?.length ?? 0})</div>
                </div>
        ...
        {/* ========================================
            PANEL 2: CONTROLS (Mobile: top, Desktop: middle)
            ======================================== */}

...
export const GenerationHistoryBlock: React.FC<GenerationHistoryBlockProps> = ({ className = '' }) => {
  ...
  return (
    <div className={\g-slate-900/60 border border-slate-800 p-4 rounded-lg shadow-lg \\} style={{ minHeight: '100px', display: 'block', visibility: 'visible', opacity: 1 }}>
...
fs.writeFileSync('C:\\\\Projects\\\\Khuyoot App\\\\Code\\\\khuyoot-خيوط\\\\src\\\\pages\\\\DesignerV2_1\\\\components\\\\GenerationHistoryBlock.tsx', content, 'utf8');

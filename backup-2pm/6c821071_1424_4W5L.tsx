...
const TRYFABRIC_STATE_KEY = 'khuyoot_tryfabric_state';
...
export type TryFabricPanelBaseHandle = {
  generate: () => void;
  openTemplatePicker: () => void;
  openFabricPicker: () => void;
};

export type TryFabricPanelBaseProps = {
...
export const TryFabricPanelBase = React.forwardRef<TryFabricPanelBaseHandle, TryFabricPanelBaseProps>(function TryFabricPanelBase(props, ref) {

  ...
  return (
    <div ref={ref} className="space-y-2 relative">
      ...
      <div className="rounded-xl border border-slate-200 dark:border-slate-700 bg-white dark:bg-slate-900 p-0.5 relative">
        <div className="p-2">
          <div className="grid grid-cols-2 gap-3 lg:grid-cols-[100px_100px] lg:justify-center">
            <button
              type="button"
            ...
            >
              ...
              <div className="mt-2 aspect-[3/4] lg:aspect-auto lg:h-[160px] xl:h-[160px] w-full rounded-lg bg-slate-200/70 dark:bg-slate-700/60 overflow-hidden">
                {originalImageUrl ? (
          ...
          {/* Generations rail: desktop (under Generate button) */}
      ...
      {/* ========================================
          ...
          ======================================== */}
      <div ref={comparisonPanelRef} className="rounded-2xl border border-slate-200 dark:border-slate-700 bg-white dark:bg-slate-900 p-2 space-y-2">
          ...
          <div className="relative">
            ...
            {/* Generations rail: mobile (under Comparison panel) */}

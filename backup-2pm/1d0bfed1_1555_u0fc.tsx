...
function TryOnResultComponent(props: TryOnResultProps, ref: React.Ref<HTMLDivElement>) {
  ...
  return (
    <div ref={ref} className="relative">
      <div className="grid grid-cols-1 gap-3 items-start lg:grid-cols-[360px_minmax(0,1fr)] lg:gap-4">
        {/* ========================================
            ...
            <div className="rounded-2xl border border-slate-200 dark:border-slate-700 bg-white dark:bg-slate-900 p-1 lg:sticky lg:bottom-3 space-y-1">
              ...
              <div className="flex items-center gap-2 w-full h-10">
                <button
                  ...
                  className={`h-12 px-3 rounded-xl border text-sm font-bold whitespace-nowrap transition-colors ${
                    testingMode
                ...
                <button
                  type="button"
                  onClick={handleRetry}
                  disabled={!originalImageUrl || !fabricThumbnailUrl || (!testingMode && !onRetry) || effectiveLoading}
                  className="flex-1 h-10 relative overflow-hidden rounded-xl bg-violet-600 text-white px-4 text-sm font-bold hover:bg-violet-700 transition-colors disabled:opacity-60 disabled:cursor-not-allowed flex items-center justify-center gap-2 whitespace-nowrap"
                >
              ...
              {/* Desktop: keep the generations rail under the generate button */}
        ...
        <div className="lg:col-start-2 lg:row-start-1 relative z-0">
          <div ref={comparisonPanelRef} className="w-full max-w-[520px] mx-auto space-y-3">
            ...
            {/* Mobile: show the generations rail under the comparison panel */}

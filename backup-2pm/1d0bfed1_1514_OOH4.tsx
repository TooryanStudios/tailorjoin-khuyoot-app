...
function TryOnResultComponent(props: TryOnResultProps, ref: React.Ref<HTMLDivElement>) {
  ...
  return (
    <div ref={ref} className="relative">
      <div className="grid grid-cols-1 gap-2 items-start lg:grid-cols-[360px_minmax(0,520px)] lg:justify-center lg:gap-3">
        {/* ========================================
        ...
        <div className="lg:col-start-2 lg:row-start-1 relative z-0">
          <div ref={comparisonPanelRef} className="w-full max-w-[520px] mx-auto space-y-2">
            <div className="tryon-comparison-panel rounded-2xl border border-slate-200 dark:border-slate-700 bg-white dark:bg-slate-900 p-2">

...
export const CanvasPanel: React.FC<CanvasPanelProps> = ({
  ...
  return (
    <AdminAnchor
      ...
      label="section-left"
      className="w-full md:flex-[1.4] min-h-[400px] md:min-h-[calc(85vh-74px)] relative bg-[#F0F0F3] dark:bg-[#050505] flex flex-col justify-start items-center overflow-visible border-b md:border-b-0 md:border-l border-slate-200 dark:border-slate-800 order-1 md:order-0"
    >

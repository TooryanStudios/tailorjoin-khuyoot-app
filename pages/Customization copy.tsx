                ...
                <div className="p-5">
                  ...
                  <div className="mb-3 p-2 bg-blue-50 dark:bg-blue-900/20 rounded-lg border border-blue-200 dark:border-blue-800">
                    <p className="text-xs font-bold text-blue-700 dark:text-blue-300">
                      {loadingTemplates ? '⏳ جاري تحميل القوالب...' : `✓ تم تحميل ${measurementTemplates.length} قالب`}
                    </p>
                    {!loadingTemplates && measurementTemplates.length > 0 && (
                      <p className="text-xs text-blue-600 dark:text-blue-400 mt-1">
                        القوالب: {measurementTemplates.map(t => t.name).join(' • ')}
                      </p>
                    )}
                  </div>
                  ...
                  {loadingTemplates ? (
                    ...
                    <div className="flex items-center justify-center h-64">
                      <div className="text-center">
                        ...
                        <p className="text-sm text-slate-600 dark:text-slate-400">لا توجد قوالب مقاسات متاحة</p>
                        <p className="text-xs text-slate-500 dark:text-slate-500 mt-1">يمكن إضافة قوالب من لوحة الإدارة</p>
                      </div>
                    </div>
                  ) : (
                    <div className="space-y-4">
                      {measurementTemplates.map((template, index) => (
                        <div
                          key={template.id}

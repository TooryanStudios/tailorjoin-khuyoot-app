...
import { Store, Package, TrendingUp, Clock, Search, Eye, CheckCircle, XCircle, DollarSign } from 'lucide-react';
...
const mockOrders: ShopOrder[] = [
  {
    id: 'SH-001',
    customerName: 'محمد الهنائي',
    items: [
      { name: 'قماش صوف - رمادي', quantity: 5, price: 15.000 },
      { name: 'أزرار فضية', quantity: 20, price: 0.500 }
    ],
    totalAmount: 85.000,
    status: 'pending',
    date: '2025-12-06',
  ...
  },
  {
    ...
    items: [
      { name: 'قماش قطن - أبيض', quantity: 10, price: 8.000 }
    ],
    totalAmount: 80.000,
    status: 'processing',
    date: '2025-12-05',
  ...
  },
  {
    ...
    items: [
      { name: 'قماش حرير - أزرق', quantity: 3, price: 25.000 },
      { name: 'خيوط ذهبية', quantity: 5, price: 3.000 }
    ],
    totalAmount: 90.000,
    status: 'completed',
    date: '2025-12-03',
  ...
  {
    id: 'SH-004',
    customerName: 'أحمد الشكيلي',
    items: [
      { name: 'قماش كتان - بيج', quantity: 8, price: 12.000 }
    ],
    totalAmount: 96.000,
    status: 'completed',
    date: '2025-12-02',
  ...
  {
    id: 'SH-005',
    customerName: 'يوسف المعمري',
    items: [
      { name: 'قماش مخمل - بني', quantity: 4, price: 20.000 }
    ],
    totalAmount: 80.000,
    status: 'cancelled',
    date: '2025-12-01',
      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="mb-8">
          <h1 className="text-3xl font-bold text-slate-900 dark:text-white mb-2 flex items-center gap-3">
            <Store className="text-green-600 dark:text-green-400" size={36} />
            طلبات المحل
          </h1>
          <p className="text-slate-600 dark:text-slate-400">
            إدارة طلبات الأقمشة والمواد من العملاء
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-4 mb-6">
          ...
          <div className="bg-white dark:bg-slate-800 rounded-xl p-4 shadow-sm border border-slate-200 dark:border-slate-700">
            <div className="flex items-center justify-between">
              <div>
                <p className="text-sm text-slate-600 dark:text-slate-400">قيد التجهيز</p>
          ...
          <div className="bg-white dark:bg-slate-800 rounded-xl p-4 shadow-sm border border-slate-200 dark:border-slate-700">
            <div className="flex items-center justify-between">
              <div>
                <p className="text-sm text-slate-600 dark:text-slate-400">إجمالي المبيعات</p>
                <p className="text-2xl font-bold text-green-600 dark:text-green-400">{stats.revenue.toFixed(0)}</p>
              </div>
        ...
        <div className="space-y-4">
          ...
          {filteredOrders.length === 0 && (
            <div className="text-center py-16">
              <Store className="mx-auto text-slate-300 dark:text-slate-600 mb-4" size={64} />

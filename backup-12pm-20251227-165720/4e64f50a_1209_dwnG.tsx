...
import { createDebouncedWriter, loadFromStorage } from '../src/utils/persist';
...
export const AppProvider: React.FC<PropsWithChildren<{}>> = ({ children }) => {
  ...
  const cartWriter = React.useMemo(
    () =>
      createDebouncedWriter<Product[]>(CART_STORAGE_KEY, {
        delayMs: 400,
        serialize: (items) =>
          JSON.stringify(

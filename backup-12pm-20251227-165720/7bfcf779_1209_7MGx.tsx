      ...
      <div className="space-y-6 max-w-4xl">
        ...
        {configSection === 'homepage' ? (
          ...
          <div className="p-5 border-t border-slate-200 dark:border-slate-700">
            <div className="flex items-center gap-4">
              <div className={`p-2 rounded-lg bg-slate-50 dark:bg-slate-900 text-indigo-500`}>
                <Moon size={20} />
              </div>
              <div className="flex-1">
                <p className="font-medium text-slate-800 dark:text-white text-sm">السمة الافتراضية</p>
                <p className="text-xs text-slate-500">اختر السمة الافتراضية عند فتح الموقع</p>
              </div>
              <select
                ...
                className="px-4 py-2 rounded-lg border border-slate-300 dark:border-slate-600 bg-white dark:bg-slate-800 text-slate-800 dark:text-white text-sm focus:outline-none focus:ring-2 focus:ring-indigo-500"
              >

    ...
    <div className="border-t border-zinc-100 bg-white p-6 shadow-sm" dir="ltr">
      <div className="grid grid-cols-2 gap-6 max-w-7xl mx-auto min-h-[420px]">
        ...
        <div className="space-y-2 flex flex-col">
          ...
          <div className="w-full aspect-[3/4] bg-zinc-50 dark:bg-zinc-900 rounded-2xl overflow-hidden border border-zinc-100 dark:border-zinc-800 flex items-center justify-center relative shadow-inner">
            {sourceForComparison ? (
              <img

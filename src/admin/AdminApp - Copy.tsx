...
import { Shield, Menu, Search, Bell, Activity, Save, PlayCircle, PenTool, ShoppingCart, Users, Lock, Scissors, Package, FileText, Store, Building2, Moon, Sun, CheckCircle } from 'lucide-react';
...
export const AdminApp = () => {
  ...
  const renderContent = () => {
    switch(activeSection) {
      ...
      case 'products': return <PlaceholderView title="إدارة المنتجات (CRUD)" icon={Package} />;
      case 'store': return (
        <div className="space-y-6 max-w-3xl">

              ...
              <div className="pt-1">
                <div className="flex items-center justify-between px-1 pb-1">
                  <div className="text-xs font-black text-slate-900 dark:text-white">
                    إبداعاتي ({safeModalGenerations.length})
                  </div>
                </div>
                <div className="flex flex-row gap-1 overflow-x-auto px-1 pb-1">
                  {safeModalGenerations.slice(0, 15).map((g) => {
                      ...
                      return (
                        <button
                          ...
                          className="group relative aspect-[3/4] h-[120px] shrink-0 rounded-lg overflow-hidden border border-slate-200 dark:border-slate-700 bg-slate-100 dark:bg-slate-800 hover:opacity-95"
                          title="عرض الصورة"
                        >
                          <img
                  ...
                  {Array.from({ length: placeholderCount }).map((_, idx) => (
                    <div
                      ...
                      className="aspect-[3/4] h-[120px] shrink-0 rounded-lg border border-dashed border-slate-200 dark:border-slate-700 bg-slate-50 dark:bg-slate-900/40"
                      aria-hidden="true"
                    />
                  ))}
                </div>

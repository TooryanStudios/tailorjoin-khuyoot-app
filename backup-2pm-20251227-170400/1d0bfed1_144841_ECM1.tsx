        ...
        <div className="lg:col-start-1 lg:row-start-1 relative z-10">
          <div className="space-y-3">
            ...
            <div className="rounded-2xl border border-slate-200 dark:border-slate-700 bg-white dark:bg-slate-900 p-1 lg:sticky lg:bottom-3 space-y-1">
              ...
              <div className="grid grid-cols-2 gap-1 lg:grid-cols-[100px_100px] lg:justify-center">
                <button
                  type="button"
                  onClick={() => {
                  ...
                  title="اختيار القالب"
                >
                  <div className="relative w-full aspect-[3/4] lg:aspect-auto lg:h-[180px] xl:h-[190px] overflow-hidden rounded-xl">
                    {originalImageUrl ? (
                      <img
